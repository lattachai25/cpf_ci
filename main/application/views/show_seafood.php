...
<?php
$this->db->select("*");
$this->db->from("seafoods");
$this->db->where("seafoods.id",$id);
$query = $this->db->get();
$beef = $query->row();
?>
            ...
            <div class="main">
                ...
                <br><br><br><br><br><br>
                    ...
                    <div class="row product-flex">
                        ...
                        <a href="<?php echo base_url('/seafood');?>" class="btn btn-clean" style="margin-top:80px; width:150px; float:right;"> Back </a>
