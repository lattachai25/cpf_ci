...
$this->db->where("turkeys.id",$id);
$query = $this->db->get();
$beef = $query->row();
?>

<?php $id_brands = $beef->id_brand; ?>
<?php $id_cat = $beef->category; ?>
<?php $id_subcat = $beef->sub_category; ?>
            ...
            <div class="main">
                ...
                <br><br><br><br><br><br>
                    ...
                    <div class="row product-flex">
                        ...
                        <a href="<?php echo base_url('/Turkey');?>" class="btn btn-clean" style="margin-top:80px; width:150px; float:right;"> Back </a>
