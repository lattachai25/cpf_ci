                    ...
                    <div class="row product-flex">
                        <div class="col-md-4 col-sm-12 product-flex-info">
                            <div class="clearfix">
                                ...
                                <h1 class="title" data-title="beef"> <?php echo $brand->name_brand_th;?> <small>BROWNES Lamb PRODUCT</small></h1>
                        ...
                        <a href="<?php echo base_url('/beef');?>" class="btn btn-clean" style="margin-top:80px; width:150px; float:right;"> Back </a>
