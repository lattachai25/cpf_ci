                        ...
                        <div class="box">
                            ...
                            <h2 class="title animated h1" data-animation="fadeInDown"><?php echo $meats->content_th;?></h2>
                                <div class="animated" data-animation="fadeInUp">
                                    <a href="<?php echo base_url('/Show/');?><?php echo $meats->id;?>" class="btn btn-clean">Read more</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <figure>
                            ...
                            <a href="<?php echo base_url('/Show/');?><?php echo $as->images_show;?>" class="btn btn-clean mfp-open-scrollto">Read more</a>
                        </figure>
                    </div>
                    <?php endforeach; ?>
                    <!-- === item === -->
                    ...
                    <div class="col-md-4">
                        <figure>
                            ...
                            <a href="<?php echo base_url('/Show/');?><?php echo $cs->id;?>" class="btn btn-clean mfp-open-scrollto">Read more</a>
                        </figure>
                    </div>
                    <?php endforeach; ?>
                    <!-- === item === -->
        ...
        <section id="page-products" class="products" style="background-color:#808080 !important;">
            ...
            <div class="container">
                ...
                <header>
                    <div class="row">
                        <div class="col-md-offset-2 col-md-8 text-center">
                            <h2 class="title" style="color:#000 !important;">OUR other PRODUCTS</h2>
                            ...
                            <div id="box-filters" class="box-filters">
                                ...
                                <figure data-filter=".22">
                                    <figcaption>
                                  <center> <i class="flaticon-fast-food" style="font-size:50px;"></i></center> 
                                        <span>แปรรูป</span>
                                    </figcaption>
                                </figure>

                                <figure data-filter=".23">
                                    <figcaption>
                                  <center> <i class="flaticon-beverages" style="font-size:50px;"></i></center> 
                                        <span>เครื่องดื่ม</span>
                                    </figcaption>
                                </figure>

                                <figure data-filter=".24">
                                    <figcaption>
                                  <center>  <i class="flaticon-sweet" style="font-size:50px;"></i></center>
                                        <span style="margin-left:-15px;">ขนมหวาน</span>
                                    </figcaption>
                                </figure>
                ...
                <?php
                        ...
                        $this->db->join('processed_products', 'processed_products.id_cat = categories.id_cat');
                        $query = $this->db->get();
                        $ou1 = $query->result();
                        ?>
                <?php
                        $this->db->select("*");
                        $this->db->from("categories");;
                        $this->db->join('beverage_products', 'beverage_products.id_cat = categories.id_cat');
                        $query = $this->db->get();
                        $ou2 = $query->result();
                ?>
                <?php
                        $this->db->select("*");
                        $this->db->from("categories");
                        $this->db->join('confectionary_products', 'confectionary_products.id_cat = categories.id_cat');
                        $query = $this->db->get();
                        $ou3 = $query->result();
                ?>
                <!-- <?php
                ...
                <div class="col-xs-6 col-sm-4 item <?php echo $ou1s->id_subcat;?>">
                    <article>
                        <div class="figure-grid">
                            <div class="image">
                                <a href="<?php echo base_url('/Show/');?><?php echo $ou1s->id;?>">
                ...
                <div class="col-xs-6 col-sm-4 item <?php echo $ou2s->id_subcat;?>">
                    <article>
                        <div class="figure-grid">
                            <div class="image">
                                <a href="<?php echo base_url('/Show/');?><?php echo $ou2s->id;?>">
                ...
                <div class="col-xs-6 col-sm-4 item <?php echo $ou3s->id_subcat;?>">
                    <article>
                        <div class="figure-grid">
                            <div class="image">
                                <a href="<?php echo base_url('/Show/');?><?php echo $ou3s->id;?>">
                ...
                <div class="col-xs-6 col-sm-4 item <?php echo $ou4s->id_subcat;?>">
                    <article>
                        <div class="figure-grid">
                            <div class="image">
                                <a href="<?php echo base_url('/Show/');?><?php echo $ou4s->id;?>">
                ...
                <div class="item" style="background-image:url(assets/uploads/<?php echo $meats->images_show;?>)">
                        <div class="box">
                            ...
                            <h2 class="title animated h1" data-animation="fadeInDown"><?php echo $meats->content_en;?></h2>
                                <div class="animated" data-animation="fadeInUp">
                                    <a href="<?php echo base_url('/Show/');?>" class="btn btn-clean">Read more</a>
                                </div>
                            </div>
                        </div>
