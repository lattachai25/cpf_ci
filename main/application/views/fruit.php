...
<section id="page-products" class="products" style="background-color:#808080 !important;">
    ...
    <div class="container">
        ...
        <header>
            <div class="row">
                <div class="col-md-offset-2 col-md-8 text-center">
                    <h2 class="title" style="color:#000 !important;">OUR fruit PRODUCTS</h2>
                    ...
                    <div id="box-filters" class="box-filters">
                        ...
                        <figure data-filter=".10">
                            <figcaption>
                           <center> <i class="flaticon-apple" style="font-size:50px;"></i></center>
                                <span>แอปเปิ้ล</span>
                            </figcaption>
                        </figure>

                        <figure data-filter=".11">
                            <figcaption>
                          <center>  <i class="flaticon-cherries" style="font-size:50px;"></i></center>
                                <span>เชอร์รี่</span>
                            </figcaption>
                        </figure>

                        <figure data-filter=".12">
                            <figcaption>
                         <center>   <i class="flaticon-peach" style="font-size:50px;"></i></center>
                                <span>ผลไม้หิน</span>
                            </figcaption>
                        </figure>

                        <figure data-filter=".13">
                            <figcaption>
                          <center>  <i class="flaticon-lime" style="font-size:50px;"></i></center>
                                <span>ส้ม</span>
                            </figcaption>
                        </figure>
        ...
        <div id="box-filters-results" class="row">
            <!-- === product-item === -->
                 <?php
                        ...
                        $this->db->join('apple_products', 'apple_products.id_cat = categories.id_cat');
                        $query = $this->db->get();
                        $ou1 = $query->result();
                        ?>
                <?php
                        $this->db->select("*");
                        $this->db->from("categories");;
                        $this->db->join('cherries_products', 'cherries_products.id_cat = categories.id_cat');
                        $query = $this->db->get();
                        $ou2 = $query->result();
                ?>
                <?php
                        $this->db->select("*");
                        $this->db->from("categories");
                        $this->db->join('stone_products', 'stone_products.id_cat = categories.id_cat');
                        $query = $this->db->get();
                        $ou3 = $query->result();
                ?>
                <?php
                        $this->db->select("*");
                        $this->db->from("categories");
                        $this->db->join('citrus_products', 'citrus_products.id_cat = categories.id_cat');
                        $query = $this->db->get();
                        $ou4 = $query->result();
                ?>
                        ...
                        <div class="figure-grid">
                            <div class="image">
                                <a href="/Show_meat/<?php echo $ou1s->id;?>">
                                    <img src="assets/uploads/<?php echo $ou1s->images_show;?>" alt="" width="360" height="250px" />
                                </a>
                            </div>
                        ...
                        <div class="figure-grid">
                            <div class="image">
                                <a href="/Show_meat/<?php echo $ou2s->id;?>">
                                    <img src="assets/uploads/<?php echo $ou2s->images_show;?>" alt="" width="360" height="250px" />
                                </a>
                            </div>
                            <div class="text radius">
                        ...
                        <div class="figure-grid">
                            <div class="image">
                                <a href="/Show_meat/<?php echo $ou3s->id;?>">
                                    <img src="assets/uploads/<?php echo $ou3s->images_show;?>" alt="" width="360" height="250px" />
                                </a>
                            </div>
                            <div class="text radius">
                        ...
                        <div class="figure-grid">
                            <div class="image">
                                <a href="<?php echo base_url('/Show/');?>">
                                    <img src="assets/uploads/<?php echo $ou4s->images_show;?>" alt="" width="360" height="250px" />
                                </a>
                            </div>
                            <div class="text radius">
