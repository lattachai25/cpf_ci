                    ...
                    <div class="box">
                        ...
                        <h2 class="title animated h1" data-animation="fadeInDown"><?php echo $meats->text_title_th;?></h2>
                            ...
                            <div class="animated" data-animation="fadeInUp">
                                <a href="<?php base_url();?>Lamb/view/<?php echo $meats->id;?>" class="btn btn-clean">Read more</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <figure>
                            ...
                            <a href="<?php base_url();?>Lamb/view/<?php echo $as->id;?>" class="btn btn-clean mfp-open-scrollto">Read more</a>
                        </figure>
                    </div>
                    <?php endforeach; ?>
                    ...
                    <div class="col-md-4">
                        <figure>
                            ...
                            <a href="<?php base_url();?>Lamb/view/<?php echo $bs->id;?>" class="btn btn-clean mfp-open-scrollto">Read more</a>
                        </figure>
                    </div>
                    <?php endforeach; ?>
                    <!-- === item === -->
        ...
        <section class="owl-icons-wrapper">
            ...
            <div class="container">
                ...
                <div class="owl-icons">
                    ...
                    <?php foreach($meat as $meats): ?>
                    <a href="<?php base_url();?>Lamb/view/{{ $meatss->id }}">
                ...
                <div id="box-filters-results" class="row">
                    ...
                    <article>
                            <div class="figure-grid">
                                <div class="image">
                                    <a href="<?php base_url();?>Lamb/view/<?php echo $meats->id;?>">
